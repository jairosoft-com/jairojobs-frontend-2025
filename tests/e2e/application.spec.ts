...
test.describe('Job Application', () => {
  ...
  test.describe('Application Form Modal', () => {
    ...
    test('should display application form modal when clicking apply', async ({
      page,
    }) => {
    ...
    test('should show character count for cover letter', async ({ page }) => {
      ...
      await coverLetterField.fill(
        testData.applicationData.coverLetter + ' Additional text.',
      );
    ...
    test('should successfully submit application with valid data', async ({
      ...
      await expect(jobDetailsPage.applicationForm.fullName).toHaveValue(
        testData.applicationData.fullName,
      );
      await expect(jobDetailsPage.applicationForm.email).toHaveValue(
        testData.applicationData.email,
      );
      await expect(jobDetailsPage.applicationForm.phone).toHaveValue(
        testData.applicationData.phone,
      );
  ...
  test.describe('Application States', () => {
    ...
    test('should show deadline passed state', async ({ page }) => {
      ...
      const deadlineMessage = page.getByText(
