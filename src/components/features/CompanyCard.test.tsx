...
describe('CompanyCard', () => {
  ...
  it('displays social links when available', () => {
    ...
    expect(linkedinLink).toHaveAttribute('href', mockCompany.socialLinks?.linkedin);
    
    const twitterLink = screen.getByLabelText('Twitter');
    expect(twitterLink).toHaveAttribute('href', mockCompany.socialLinks?.twitter);
  });
  ...
  it('renders view all jobs button', () => {
    ...
    const viewJobsButton = screen.getByRole('button', { name: /view all jobs/i });
