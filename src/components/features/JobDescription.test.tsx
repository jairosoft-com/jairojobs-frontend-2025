...
describe('JobDescription', () => {
  it('renders job description with proper formatting', () => {
    ...
    expect(screen.getByText(/This is an exciting opportunity/)).toBeInTheDocument();
    expect(screen.getByText(/You will be working with a talented team/)).toBeInTheDocument();
  });
  ...
  it('preserves line breaks in description', () => {
    ...
    const descriptionSection = screen.getByText(/We are looking for a Senior Software Engineer/).parentElement;
